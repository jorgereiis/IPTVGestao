...
async function getSessionToken() {
    ...
    const base_url = 'http://api.meusistema.com.br:21465/api/';
    const user = document.getElementById('user-session').value;
...
function enviarMensagemWpp() {
    ...
    if (imagem) {
        var url = 'http://api.meusistema.com.br:21465/api/' + usuario + '/send-file';
        ...
        var url = 'http://api.meusistema.com.br:21465/api/' + usuario + '/send-message';
